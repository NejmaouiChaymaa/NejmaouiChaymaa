// Renders ojo-nature/infographic.standalone.html to a full-height PNG (2x) and a single-page PDF.
...
(async () => {
  ...
  await (await page.$('.poster')).screenshot({ path: path.join(OUT, 'ojo-nature-case-study-infographic@2x.png') });
  await page.pdf({ path: path.join(OUT, 'ojo-nature-case-study-infographic.pdf'),
